 ...
 * @author Google, Inc.
 */
class GoogleGAL_Service_Container extends GoogleGAL_Service {
	...
	public function __construct( GoogleGAL_Client $client ) {
		...
		$this->projects_clusters         = new GoogleGAL_Service_Container_ProjectsClusters_Resource(
			$this,
			$this->serviceName,
			'clusters',
			array(
		...
		$this->projects_operations       = new GoogleGAL_Service_Container_ProjectsOperations_Resource(
			$this,
			$this->serviceName,
			'operations',
			array(
		...
		$this->projects_zones_clusters   = new GoogleGAL_Service_Container_ProjectsZonesClusters_Resource(
			$this,
			$this->serviceName,
			'clusters',
			array(
		...
		$this->projects_zones_operations = new GoogleGAL_Service_Container_ProjectsZonesOperations_Resource(
			$this,
			$this->serviceName,
			'operations',
			array(
 ...
 * Typical usage is:
 *  <code>
 *   $containerService = new GoogleGAL_Service_Container(...);
 *   $projects = $containerService->projects;
 *  </code>
 */
class GoogleGAL_Service_Container_Projects_Resource extends GoogleGAL_Service_Resource {
 ...
 *  </code>
 */
class GoogleGAL_Service_Container_ProjectsClusters_Resource extends GoogleGAL_Service_Resource {
	 ...
	 * @return GoogleGAL_Service_Container_ListAggregatedClustersResponse
	 */
	public function listProjectsClusters( $projectId, $optParams = array() ) {
		$params = array( 'projectId' => $projectId );
		$params = array_merge( $params, $optParams );
		return $this->call( 'list', array( $params ), 'GoogleGAL_Service_Container_ListAggregatedClustersResponse' );
	}
}
/**
 ...
 *  </code>
 */
class GoogleGAL_Service_Container_ProjectsOperations_Resource extends GoogleGAL_Service_Resource {
	 ...
	 * number.
	 * @param array  $optParams Optional parameters.
	 * @return GoogleGAL_Service_Container_ListAggregatedOperationsResponse
	 */
	public function listProjectsOperations( $projectId, $optParams = array() ) {
		$params = array( 'projectId' => $projectId );
		$params = array_merge( $params, $optParams );
		return $this->call( 'list', array( $params ), 'GoogleGAL_Service_Container_ListAggregatedOperationsResponse' );
	}
}
/**
 ...
 *  </code>
 */
class GoogleGAL_Service_Container_ProjectsZones_Resource extends GoogleGAL_Service_Resource {
 ...
 *  </code>
 */
class GoogleGAL_Service_Container_ProjectsZonesClusters_Resource extends GoogleGAL_Service_Resource {
	 ...
	 *                         cluster resides.
	 * @param GoogleGAL_CreateClusterRequest $postBody
	 * @param array                          $optParams Optional parameters.
	 * @return GoogleGAL_Service_Container_Operation
	 */
	public function create( $projectId, $zoneId, GoogleGAL_Service_Container_CreateClusterRequest $postBody, $optParams = array() ) {
		$params = array(
			'projectId' => $projectId,
			'zoneId'    => $zoneId,
			'postBody'  => $postBody,
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'create', array( $params ), 'GoogleGAL_Service_Container_Operation' );
	}
	...
	public function delete( $projectId, $zoneId, $clusterId, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'delete', array( $params ), 'GoogleGAL_Service_Container_Operation' );
	}
	 ...
	 * @param array  $optParams Optional parameters.
	 * @return GoogleGAL_Service_Container_Cluster
	 */
	public function get( $projectId, $zoneId, $clusterId, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'get', array( $params ), 'GoogleGAL_Service_Container_Cluster' );
	}
	 ...
	 * cluster resides.
	 * @param array  $optParams Optional parameters.
	 * @return GoogleGAL_Service_Container_ListClustersResponse
	 */
	public function listProjectsZonesClusters( $projectId, $zoneId, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'list', array( $params ), 'GoogleGAL_Service_Container_ListClustersResponse' );
	}
}
/**
 * The "operations" collection of methods.
 ...
 *  </code>
 */
class GoogleGAL_Service_Container_ProjectsZonesOperations_Resource extends GoogleGAL_Service_Resource {
	...
	public function get( $projectId, $zoneId, $operationId, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'get', array( $params ), 'GoogleGAL_Service_Container_Operation' );
	}
	 ...
	 * operations for.
	 * @param array  $optParams Optional parameters.
	 * @return GoogleGAL_Service_Container_ListOperationsResponse
	 */
	public function listProjectsZonesOperations( $projectId, $zoneId, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'list', array( $params ), 'GoogleGAL_Service_Container_ListOperationsResponse' );
	}
}
...
class GoogleGAL_Service_Container_Cluster extends GoogleGAL_Model {
	...
	public $description;
	public $endpoint;
	protected $masterAuthType     = 'GoogleGAL_Service_Container_MasterAuth';
	protected $masterAuthDataType = '';
	public $name;
	protected $nodeConfigType     = 'GoogleGAL_Service_Container_NodeConfig';
	...
	public function setMasterAuth( GoogleGAL_Service_Container_MasterAuth $masterAuth ) {
	...
	public function setNodeConfig( GoogleGAL_Service_Container_NodeConfig $nodeConfig ) {
...
class GoogleGAL_Service_Container_CreateClusterRequest extends GoogleGAL_Model {

	protected $internal_gapi_mappings = array();
	protected $clusterType            = 'GoogleGAL_Service_Container_Cluster';
	protected $clusterDataType        = '';


	public function setCluster( GoogleGAL_Service_Container_Cluster $cluster ) {
...
class GoogleGAL_Service_Container_ListAggregatedClustersResponse extends GoogleGAL_Collection {

	protected $collection_key         = 'clusters';
	protected $internal_gapi_mappings = array();
	protected $clustersType           = 'GoogleGAL_Service_Container_Cluster';
...
class GoogleGAL_Service_Container_ListAggregatedOperationsResponse extends GoogleGAL_Collection {

	protected $collection_key         = 'operations';
	protected $internal_gapi_mappings = array();
	protected $operationsType         = 'GoogleGAL_Service_Container_Operation';
...
class GoogleGAL_Service_Container_ListClustersResponse extends GoogleGAL_Collection {
...
class GoogleGAL_Service_Container_ListOperationsResponse extends GoogleGAL_Collection {
...
class GoogleGAL_Service_Container_MasterAuth extends GoogleGAL_Model {
...
class GoogleGAL_Service_Container_NodeConfig extends GoogleGAL_Model {
...
class GoogleGAL_Service_Container_Operation extends GoogleGAL_Model {
