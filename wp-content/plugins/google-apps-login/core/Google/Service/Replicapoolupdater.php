 ...
 * @author Google, Inc.
 */
class GoogleGAL_Service_Replicapoolupdater extends GoogleGAL_Service {
 ...
 * Typical usage is:
 *  <code>
 *   $replicapoolupdaterService = new GoogleGAL_Service_Replicapoolupdater(...);
 *   $updates = $replicapoolupdaterService->updates;
 *  </code>
 */
class GoogleGAL_Service_Replicapoolupdater_Updates_Resource extends GoogleGAL_Service_Resource {
	 ...
	 * @param string $update Unique (in the context of a group) handle of an update.
	 * @param array  $optParams Optional parameters.
	 * @return GoogleGAL_Service_Replicapoolupdater_Update
	 */
	public function get( $project, $zone, $instanceGroupManager, $update, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'get', array( $params ), 'GoogleGAL_Service_Replicapoolupdater_Update' );
	}
	 ...
	 * @param array            $optParams Optional parameters.
	 * @return GoogleGAL_Service_Replicapoolupdater_InsertResponse
	 */
	public function insert( $project, $zone, $instanceGroupManager, GoogleGAL_Service_Replicapoolupdater_Update $postBody, $optParams = array() ) {
		$params = array(
			'project'              => $project,
			'zone'                 => $zone,
			'instanceGroupManager' => $instanceGroupManager,
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'insert', array( $params ), 'GoogleGAL_Service_Replicapoolupdater_InsertResponse' );
	}
	 ...
	 * @return GoogleGAL_Service_Replicapoolupdater_UpdateList
	 */
	public function listUpdates( $project, $zone, $instanceGroupManager, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'list', array( $params ), 'GoogleGAL_Service_Replicapoolupdater_UpdateList' );
	}
...
class GoogleGAL_Service_Replicapoolupdater_InsertResponse extends GoogleGAL_Model {
...
class GoogleGAL_Service_Replicapoolupdater_InstanceUpdate extends GoogleGAL_Model {
...
class GoogleGAL_Service_Replicapoolupdater_Update extends GoogleGAL_Collection {
	...
	protected $instanceUpdatesType     = 'GoogleGAL_Service_Replicapoolupdater_InstanceUpdate';
	protected $instanceUpdatesDataType = 'array';
	public $kind;
	protected $policyType     = 'GoogleGAL_Service_Replicapoolupdater_UpdatePolicy';
	...
	public function setPolicy( GoogleGAL_Service_Replicapoolupdater_UpdatePolicy $policy ) {
		$this->policy = $policy;
	}
...
class GoogleGAL_Service_Replicapoolupdater_UpdateList extends GoogleGAL_Collection {

	protected $collection_key         = 'items';
	protected $internal_gapi_mappings = array();
	protected $itemsType              = 'GoogleGAL_Service_Replicapoolupdater_Update';
...
class GoogleGAL_Service_Replicapoolupdater_UpdatePolicy extends GoogleGAL_Model {

	protected $internal_gapi_mappings = array();
	protected $canaryType             = 'GoogleGAL_Service_Replicapoolupdater_UpdatePolicyCanary';
	protected $canaryDataType         = '';
	public $maxNumConcurrentInstances;
	public $sleepAfterInstanceRestartSec;


	public function setCanary( GoogleGAL_Service_Replicapoolupdater_UpdatePolicyCanary $canary ) {
		$this->canary = $canary;
	}
...
class GoogleGAL_Service_Replicapoolupdater_UpdatePolicyCanary extends GoogleGAL_Model {
