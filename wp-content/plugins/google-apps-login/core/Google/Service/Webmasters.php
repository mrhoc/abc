 ...
 * @author Google, Inc.
 */
class GoogleGAL_Service_Webmasters extends GoogleGAL_Service {
	...
	public function __construct( GoogleGAL_Client $client ) {
		...
		$this->sitemaps              = new GoogleGAL_Service_Webmasters_Sitemaps_Resource(
			$this,
			$this->serviceName,
			'sitemaps',
			array(
		...
		$this->sites                 = new GoogleGAL_Service_Webmasters_Sites_Resource(
			$this,
			$this->serviceName,
			'sites',
			array(
		...
		$this->urlcrawlerrorscounts  = new GoogleGAL_Service_Webmasters_Urlcrawlerrorscounts_Resource(
			$this,
			$this->serviceName,
		...
		$this->urlcrawlerrorssamples = new GoogleGAL_Service_Webmasters_Urlcrawlerrorssamples_Resource(
			$this,
			$this->serviceName,
 ...
 * Typical usage is:
 *  <code>
 *   $webmastersService = new GoogleGAL_Service_Webmasters(...);
 *   $sitemaps = $webmastersService->sitemaps;
 *  </code>
 */
class GoogleGAL_Service_Webmasters_Sitemaps_Resource extends GoogleGAL_Service_Resource {
	 ...
	 * http://www.example.com/sitemap.xml).
	 * @param array  $optParams Optional parameters.
	 * @return GoogleGAL_Service_Webmasters_WmxSitemap
	 */
	public function get( $siteUrl, $feedpath, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'get', array( $params ), 'GoogleGAL_Service_Webmasters_WmxSitemap' );
	}
	 ...
	 * @return GoogleGAL_Service_Webmasters_SitemapsListResponse
	 */
	public function listSitemaps( $siteUrl, $optParams = array() ) {
		$params = array( 'siteUrl' => $siteUrl );
		$params = array_merge( $params, $optParams );
		return $this->call( 'list', array( $params ), 'GoogleGAL_Service_Webmasters_SitemapsListResponse' );
	}
 ...
 *  </code>
 */
class GoogleGAL_Service_Webmasters_Sites_Resource extends GoogleGAL_Service_Resource {
	 ...
	 * 'http://www.example.com/'
	 * @param array  $optParams Optional parameters.
	 * @return GoogleGAL_Service_Webmasters_WmxSite
	 */
	public function get( $siteUrl, $optParams = array() ) {
		$params = array( 'siteUrl' => $siteUrl );
		$params = array_merge( $params, $optParams );
		return $this->call( 'get', array( $params ), 'GoogleGAL_Service_Webmasters_WmxSite' );
	}
	 ...
	 *
	 * @param array $optParams Optional parameters.
	 * @return GoogleGAL_Service_Webmasters_SitesListResponse
	 */
	public function listSites( $optParams = array() ) {
		$params = array();
		$params = array_merge( $params, $optParams );
		return $this->call( 'list', array( $params ), 'GoogleGAL_Service_Webmasters_SitesListResponse' );
	}
}
 ...
 *  </code>
 */
class GoogleGAL_Service_Webmasters_Urlcrawlerrorscounts_Resource extends GoogleGAL_Service_Resource {
	 ...
	 * counts.
	 * @return GoogleGAL_Service_Webmasters_UrlCrawlErrorsCountsQueryResponse
	 */
	public function query( $siteUrl, $optParams = array() ) {
		$params = array( 'siteUrl' => $siteUrl );
		$params = array_merge( $params, $optParams );
		return $this->call( 'query', array( $params ), 'GoogleGAL_Service_Webmasters_UrlCrawlErrorsCountsQueryResponse' );
	}
}
 ...
 *  </code>
 */
class GoogleGAL_Service_Webmasters_Urlcrawlerrorssamples_Resource extends GoogleGAL_Service_Resource {
	 ...
	 * for example 'web'
	 * @param array  $optParams Optional parameters.
	 * @return GoogleGAL_Service_Webmasters_UrlCrawlErrorsSample
	 */
	public function get( $siteUrl, $url, $category, $platform, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'get', array( $params ), 'GoogleGAL_Service_Webmasters_UrlCrawlErrorsSample' );
	}
	 ...
	 * for example 'web'
	 * @param array  $optParams Optional parameters.
	 * @return GoogleGAL_Service_Webmasters_UrlCrawlErrorsSamplesListResponse
	 */
	public function listUrlcrawlerrorssamples( $siteUrl, $category, $platform, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'list', array( $params ), 'GoogleGAL_Service_Webmasters_UrlCrawlErrorsSamplesListResponse' );
	}
...
class GoogleGAL_Service_Webmasters_SitemapsListResponse extends GoogleGAL_Collection {

	protected $collection_key         = 'sitemap';
	protected $internal_gapi_mappings = array();
	protected $sitemapType            = 'GoogleGAL_Service_Webmasters_WmxSitemap';
...
class GoogleGAL_Service_Webmasters_SitesListResponse extends GoogleGAL_Collection {

	protected $collection_key         = 'siteEntry';
	protected $internal_gapi_mappings = array();
	protected $siteEntryType          = 'GoogleGAL_Service_Webmasters_WmxSite';
...
class GoogleGAL_Service_Webmasters_UrlCrawlErrorCount extends GoogleGAL_Model {
...
class GoogleGAL_Service_Webmasters_UrlCrawlErrorCountsPerType extends GoogleGAL_Collection {

	protected $collection_key         = 'entries';
	protected $internal_gapi_mappings = array();
	public $category;
	protected $entriesType     = 'GoogleGAL_Service_Webmasters_UrlCrawlErrorCount';
...
class GoogleGAL_Service_Webmasters_UrlCrawlErrorsCountsQueryResponse extends GoogleGAL_Collection {

	protected $collection_key         = 'countPerTypes';
	protected $internal_gapi_mappings = array();
	protected $countPerTypesType      = 'GoogleGAL_Service_Webmasters_UrlCrawlErrorCountsPerType';
...
class GoogleGAL_Service_Webmasters_UrlCrawlErrorsSample extends GoogleGAL_Model {
	...
	public $pageUrl;
	public $responseCode;
	protected $urlDetailsType     = 'GoogleGAL_Service_Webmasters_UrlSampleDetails';
	...
	public function setUrlDetails( GoogleGAL_Service_Webmasters_UrlSampleDetails $urlDetails ) {
...
class GoogleGAL_Service_Webmasters_UrlCrawlErrorsSamplesListResponse extends GoogleGAL_Collection {

	protected $collection_key              = 'urlCrawlErrorSample';
	protected $internal_gapi_mappings      = array();
	protected $urlCrawlErrorSampleType     = 'GoogleGAL_Service_Webmasters_UrlCrawlErrorsSample';
...
class GoogleGAL_Service_Webmasters_UrlSampleDetails extends GoogleGAL_Collection {
...
class GoogleGAL_Service_Webmasters_WmxSite extends GoogleGAL_Model {
...
class GoogleGAL_Service_Webmasters_WmxSitemap extends GoogleGAL_Collection {

	protected $collection_key         = 'contents';
	protected $internal_gapi_mappings = array();
	protected $contentsType           = 'GoogleGAL_Service_Webmasters_WmxSitemapContent';
...
class GoogleGAL_Service_Webmasters_WmxSitemapContent extends GoogleGAL_Model {
