...
class GoogleGAL_Service_Fusiontables extends GoogleGAL_Service {
	...
	public function __construct( GoogleGAL_Client $client ) {
		...
		$this->task     = new GoogleGAL_Service_Fusiontables_Task_Resource(
			$this,
			$this->serviceName,
			'task',
			array(
...
class GoogleGAL_Service_Fusiontables_Table_Resource extends GoogleGAL_Service_Resource {
	 ...
	 * @return GoogleGAL_Service_Fusiontables_Task
	 */
	public function replaceRows( $tableId, $optParams = array() ) {
		$params = array( 'tableId' => $tableId );
		$params = array_merge( $params, $optParams );
		return $this->call( 'replaceRows', array( $params ), 'GoogleGAL_Service_Fusiontables_Task' );
	}
 ...
 *  </code>
 */
class GoogleGAL_Service_Fusiontables_Task_Resource extends GoogleGAL_Service_Resource {
	...
	public function get( $tableId, $taskId, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'get', array( $params ), 'GoogleGAL_Service_Fusiontables_Task' );
	}
	 ...
	 * @return GoogleGAL_Service_Fusiontables_TaskList
	 */
	public function listTask( $tableId, $optParams = array() ) {
		$params = array( 'tableId' => $tableId );
		$params = array_merge( $params, $optParams );
		return $this->call( 'list', array( $params ), 'GoogleGAL_Service_Fusiontables_TaskList' );
	}
}
...
class GoogleGAL_Service_Fusiontables_Column extends GoogleGAL_Collection {
...
class GoogleGAL_Service_Fusiontables_Task extends GoogleGAL_Model {
...
class GoogleGAL_Service_Fusiontables_TaskList extends GoogleGAL_Collection {

	protected $collection_key         = 'items';
	protected $internal_gapi_mappings = array();
	protected $itemsType              = 'GoogleGAL_Service_Fusiontables_Task';
	protected $itemsDataType          = 'array';
	public $kind;
	public $nextPageToken;
	public $totalItems;
