...
class GoogleGAL_Service_CivicInfo_Representatives_Resource extends GoogleGAL_Service_Resource {
	...
	public function representativeInfoByAddress( $optParams = array() ) {
		$params = array();
		$params = array_merge( $params, $optParams );
		return $this->call( 'representativeInfoByAddress', array( $params ), 'GoogleGAL_Service_CivicInfo_RepresentativeInfoResponse' );
	}
	 ...
	 * fulfilling one of these roles will be returned. Divisions that don't contain
	 * a matching office will not be returned.
	 * @return GoogleGAL_Service_CivicInfo_RepresentativeInfoData
	 */
	public function representativeInfoByDivision( $ocdId, $optParams = array() ) {
		$params = array( 'ocdId' => $ocdId );
		$params = array_merge( $params, $optParams );
		return $this->call( 'representativeInfoByDivision', array( $params ), 'GoogleGAL_Service_CivicInfo_RepresentativeInfoData' );
	}
}
...
class GoogleGAL_Service_CivicInfo_DivisionSearchResult extends GoogleGAL_Collection {
...
class GoogleGAL_Service_CivicInfo_RepresentativeInfoData extends GoogleGAL_Collection {
...
class GoogleGAL_Service_CivicInfo_RepresentativeInfoDataDivisions extends GoogleGAL_Model {

}

class GoogleGAL_Service_CivicInfo_RepresentativeInfoResponse extends GoogleGAL_Collection {
...
class GoogleGAL_Service_CivicInfo_RepresentativeInfoResponseDivisions extends GoogleGAL_Model {
...
class GoogleGAL_Service_CivicInfo_VoterInfoResponse extends GoogleGAL_Collection {
	...
	protected $dropOffLocationsType     = 'GoogleGAL_Service_CivicInfo_PollingLocation';
	...
	protected $normalizedInputType      = 'GoogleGAL_Service_CivicInfo_SimpleAddressType';
	protected $normalizedInputDataType  = '';
	protected $otherElectionsType       = 'GoogleGAL_Service_CivicInfo_Election';
