...
class GoogleGAL_Service_Reseller_Subscriptions_Resource extends GoogleGAL_Service_Resource {
	...
	public function activate( $customerId, $subscriptionId, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'activate', array( $params ), 'GoogleGAL_Service_Reseller_Subscription' );
	}
	...
	public function suspend( $customerId, $subscriptionId, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'suspend', array( $params ), 'GoogleGAL_Service_Reseller_Subscription' );
	}
}
