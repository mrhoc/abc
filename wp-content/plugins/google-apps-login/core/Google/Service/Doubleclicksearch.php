...
class GoogleGAL_Service_Doubleclicksearch_ReportApiColumnSpec extends GoogleGAL_Model {
...
class GoogleGAL_Service_Doubleclicksearch_ReportRequest extends GoogleGAL_Collection {
	...
	protected $internal_gapi_mappings = array();
	protected $columnsType            = 'GoogleGAL_Service_Doubleclicksearch_ReportApiColumnSpec';
...
class GoogleGAL_Service_Doubleclicksearch_ReportRequestFilters extends GoogleGAL_Collection {
	...
	protected $internal_gapi_mappings = array();
	protected $columnType             = 'GoogleGAL_Service_Doubleclicksearch_ReportApiColumnSpec';
	protected $columnDataType         = '';
	public $operator;
	public $values;


	public function setColumn( GoogleGAL_Service_Doubleclicksearch_ReportApiColumnSpec $column ) {
		$this->column = $column;
	}
...
class GoogleGAL_Service_Doubleclicksearch_ReportRow extends GoogleGAL_Model {
