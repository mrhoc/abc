...
class GoogleGAL_Service_Resourceviews extends GoogleGAL_Service {
	...
	public function __construct( GoogleGAL_Client $client ) {
		...
		$this->zoneOperations = new GoogleGAL_Service_Resourceviews_ZoneOperations_Resource(
			$this,
			$this->serviceName,
			'zoneOperations',
			array(
 ...
 *  </code>
 */
class GoogleGAL_Service_Resourceviews_ZoneOperations_Resource extends GoogleGAL_Service_Resource {
	 ...
	 * @return GoogleGAL_Service_Resourceviews_Operation
	 */
	public function get( $project, $zone, $operation, $optParams = array() ) {
		...
		return $this->call( 'get', array( $params ), 'GoogleGAL_Service_Resourceviews_Operation' );
	}
	 ...
	 * @return GoogleGAL_Service_Resourceviews_OperationList
	 */
	public function listZoneOperations( $project, $zone, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'list', array( $params ), 'GoogleGAL_Service_Resourceviews_OperationList' );
	}
}
...
class GoogleGAL_Service_Resourceviews_ZoneViews_Resource extends GoogleGAL_Service_Resource {
	 ...
	 * @return GoogleGAL_Service_Resourceviews_Operation
	 */
	public function addResources( $project, $zone, $resourceView, GoogleGAL_Service_Resourceviews_ZoneViewsAddResourcesRequest $postBody, $optParams = array() ) {
		$params = array(
			'project'      => $project,
			'zone'         => $zone,
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'addResources', array( $params ), 'GoogleGAL_Service_Resourceviews_Operation' );
	}
	...
	public function delete( $project, $zone, $resourceView, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'delete', array( $params ), 'GoogleGAL_Service_Resourceviews_Operation' );
	}
	 ...
	 * @return GoogleGAL_Service_Resourceviews_ZoneViewsGetServiceResponse
	 */
	public function getService( $project, $zone, $resourceView, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'getService', array( $params ), 'GoogleGAL_Service_Resourceviews_ZoneViewsGetServiceResponse' );
	}
	 ...
	 * @return GoogleGAL_Service_Resourceviews_Operation
	 */
	public function insert( $project, $zone, GoogleGAL_Service_Resourceviews_ResourceView $postBody, $optParams = array() ) {
		$params = array(
			'project'  => $project,
			'zone'     => $zone,
			'postBody' => $postBody,
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'insert', array( $params ), 'GoogleGAL_Service_Resourceviews_Operation' );
	}
	 ...
	 * @return GoogleGAL_Service_Resourceviews_ZoneViewsList
	 */
	public function listZoneViews( $project, $zone, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'list', array( $params ), 'GoogleGAL_Service_Resourceviews_ZoneViewsList' );
	}
	 ...
	 * @return GoogleGAL_Service_Resourceviews_Operation
	 */
	public function removeResources( $project, $zone, $resourceView, GoogleGAL_Service_Resourceviews_ZoneViewsRemoveResourcesRequest $postBody, $optParams = array() ) {
		$params = array(
			'project'      => $project,
			'zone'         => $zone,
			'resourceView' => $resourceView,
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'removeResources', array( $params ), 'GoogleGAL_Service_Resourceviews_Operation' );
	}
	 ...
	 * @param string                               $zone The zone name of the resource view.
	 * @param string                               $resourceView The name of the resource view.
	 * @param GoogleGAL_ZoneViewsSetServiceRequest $postBody
	 * @param array                                $optParams Optional parameters.
	 * @return GoogleGAL_Service_Resourceviews_Operation
	 */
	public function setService( $project, $zone, $resourceView, GoogleGAL_Service_Resourceviews_ZoneViewsSetServiceRequest $postBody, $optParams = array() ) {
		$params = array(
			'project'      => $project,
			'zone'         => $zone,
			'resourceView' => $resourceView,
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'setService', array( $params ), 'GoogleGAL_Service_Resourceviews_Operation' );
	}
}
...
class GoogleGAL_Service_Resourceviews_ListResourceResponseItem extends GoogleGAL_Model {
...
class GoogleGAL_Service_Resourceviews_ListResourceResponseItemEndpoints extends GoogleGAL_Model {

}

class GoogleGAL_Service_Resourceviews_Operation extends GoogleGAL_Collection {
	...
	public $endTime;
	protected $errorType     = 'GoogleGAL_Service_Resourceviews_OperationError';
	...
	public $targetLink;
	public $user;
	protected $warningsType     = 'GoogleGAL_Service_Resourceviews_OperationWarnings';
	...
	public function setError( GoogleGAL_Service_Resourceviews_OperationError $error ) {
		$this->error = $error;
	}
...
class GoogleGAL_Service_Resourceviews_OperationError extends GoogleGAL_Collection {

	protected $collection_key         = 'errors';
	protected $internal_gapi_mappings = array();
	protected $errorsType             = 'GoogleGAL_Service_Resourceviews_OperationErrorErrors';
...
class GoogleGAL_Service_Resourceviews_OperationErrorErrors extends GoogleGAL_Model {
...
class GoogleGAL_Service_Resourceviews_OperationList extends GoogleGAL_Collection {

	protected $collection_key         = 'items';
	protected $internal_gapi_mappings = array();
	public $id;
	protected $itemsType     = 'GoogleGAL_Service_Resourceviews_Operation';
...
class GoogleGAL_Service_Resourceviews_OperationWarnings extends GoogleGAL_Collection {

	protected $collection_key         = 'data';
	protected $internal_gapi_mappings = array();
	public $code;
	protected $dataType     = 'GoogleGAL_Service_Resourceviews_OperationWarningsData';
...
class GoogleGAL_Service_Resourceviews_OperationWarningsData extends GoogleGAL_Model {
...
class GoogleGAL_Service_Resourceviews_ResourceView extends GoogleGAL_Collection {
	...
	public $creationTimestamp;
	public $description;
	protected $endpointsType     = 'GoogleGAL_Service_Resourceviews_ServiceEndpoint';
...
class GoogleGAL_Service_Resourceviews_ServiceEndpoint extends GoogleGAL_Model {
...
class GoogleGAL_Service_Resourceviews_ZoneViewsGetServiceResponse extends GoogleGAL_Collection {
...
class GoogleGAL_Service_Resourceviews_ZoneViewsList extends GoogleGAL_Collection {

	protected $collection_key         = 'items';
	protected $internal_gapi_mappings = array();
	protected $itemsType              = 'GoogleGAL_Service_Resourceviews_ResourceView';
	protected $itemsDataType          = 'array';
	public $kind;
	public $nextPageToken;
	public $selfLink;
...
class GoogleGAL_Service_Resourceviews_ZoneViewsListResourcesResponse extends GoogleGAL_Collection {
	...
	protected $collection_key         = 'items';
	protected $internal_gapi_mappings = array();
	protected $itemsType              = 'GoogleGAL_Service_Resourceviews_ListResourceResponseItem';
	protected $itemsDataType          = 'array';
	public $network;
	public $nextPageToken;
...
class GoogleGAL_Service_Resourceviews_ZoneViewsSetServiceRequest extends GoogleGAL_Collection {
