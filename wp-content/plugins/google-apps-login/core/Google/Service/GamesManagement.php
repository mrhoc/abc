...
class GoogleGAL_Service_GamesManagement extends GoogleGAL_Service {
	...
	public function __construct( GoogleGAL_Client $client ) {
		...
		$this->events           = new GoogleGAL_Service_GamesManagement_Events_Resource(
			$this,
			$this->serviceName,
			'events',
			array(
		...
		$this->quests           = new GoogleGAL_Service_GamesManagement_Quests_Resource(
			$this,
			$this->serviceName,
			'quests',
			array(
...
class GoogleGAL_Service_GamesManagement_Achievements_Resource extends GoogleGAL_Service_Resource {
	 ...
	 *
	 * @param GoogleGAL_AchievementResetMultipleForAllRequest $postBody
	 * @param array                                           $optParams Optional parameters.
	 */
	public function resetMultipleForAllPlayers( GoogleGAL_Service_GamesManagement_AchievementResetMultipleForAllRequest $postBody, $optParams = array() ) {
 ...
 *  </code>
 */
class GoogleGAL_Service_GamesManagement_Events_Resource extends GoogleGAL_Service_Resource {
	 ...
	 *
	 * @param GoogleGAL_EventsResetMultipleForAllRequest $postBody
	 * @param array                                      $optParams Optional parameters.
	 */
	public function resetMultipleForAllPlayers( GoogleGAL_Service_GamesManagement_EventsResetMultipleForAllRequest $postBody, $optParams = array() ) {
		$params = array( 'postBody' => $postBody );
		$params = array_merge( $params, $optParams );
		return $this->call( 'resetMultipleForAllPlayers', array( $params ) );
	}
 ...
 *  </code>
 */
class GoogleGAL_Service_GamesManagement_Quests_Resource extends GoogleGAL_Service_Resource {
	 ...
	 *
	 * @param GoogleGAL_QuestsResetMultipleForAllRequest $postBody
	 * @param array                                      $optParams Optional parameters.
	 */
	public function resetMultipleForAllPlayers( GoogleGAL_Service_GamesManagement_QuestsResetMultipleForAllRequest $postBody, $optParams = array() ) {
		$params = array( 'postBody' => $postBody );
		$params = array_merge( $params, $optParams );
		return $this->call( 'resetMultipleForAllPlayers', array( $params ) );
	}
...
class GoogleGAL_Service_GamesManagement_Scores_Resource extends GoogleGAL_Service_Resource {
	 ...
	 *
	 * @param array $optParams Optional parameters.
	 * @return GoogleGAL_Service_GamesManagement_PlayerScoreResetAllResponse
	 */
	public function resetAll( $optParams = array() ) {
		$params = array();
		$params = array_merge( $params, $optParams );
		return $this->call( 'resetAll', array( $params ), 'GoogleGAL_Service_GamesManagement_PlayerScoreResetAllResponse' );
	}
	 ...
	 *
	 * @param GoogleGAL_ScoresResetMultipleForAllRequest $postBody
	 * @param array                                      $optParams Optional parameters.
	 */
	public function resetMultipleForAllPlayers( GoogleGAL_Service_GamesManagement_ScoresResetMultipleForAllRequest $postBody, $optParams = array() ) {
		$params = array( 'postBody' => $postBody );
		$params = array_merge( $params, $optParams );
		return $this->call( 'resetMultipleForAllPlayers', array( $params ) );
	}
...
class GoogleGAL_Service_GamesManagement_AchievementResetMultipleForAllRequest extends GoogleGAL_Collection {
...
class GoogleGAL_Service_GamesManagement_EventsResetMultipleForAllRequest extends GoogleGAL_Collection {
...
class GoogleGAL_Service_GamesManagement_GamesPlayerExperienceInfoResource extends GoogleGAL_Model {

	protected $internal_gapi_mappings = array();
	public $currentExperiencePoints;
	protected $currentLevelType     = 'GoogleGAL_Service_GamesManagement_GamesPlayerLevelResource';
	protected $currentLevelDataType = '';
	public $lastLevelUpTimestampMillis;
	protected $nextLevelType     = 'GoogleGAL_Service_GamesManagement_GamesPlayerLevelResource';
	...
	public function setCurrentLevel( GoogleGAL_Service_GamesManagement_GamesPlayerLevelResource $currentLevel ) {
	...
	public function setNextLevel( GoogleGAL_Service_GamesManagement_GamesPlayerLevelResource $nextLevel ) {
...
class GoogleGAL_Service_GamesManagement_GamesPlayerLevelResource extends GoogleGAL_Model {
...
class GoogleGAL_Service_GamesManagement_Player extends GoogleGAL_Model {
	...
	public $displayName;
	protected $experienceInfoType     = 'GoogleGAL_Service_GamesManagement_GamesPlayerExperienceInfoResource';
	...
	public function setExperienceInfo( GoogleGAL_Service_GamesManagement_GamesPlayerExperienceInfoResource $experienceInfo ) {
...
class GoogleGAL_Service_GamesManagement_PlayerScoreResetAllResponse extends GoogleGAL_Collection {

	protected $collection_key         = 'results';
	protected $internal_gapi_mappings = array();
	public $kind;
	protected $resultsType     = 'GoogleGAL_Service_GamesManagement_PlayerScoreResetResponse';
	protected $resultsDataType = 'array';
...
class GoogleGAL_Service_GamesManagement_QuestsResetMultipleForAllRequest extends GoogleGAL_Collection {
...
class GoogleGAL_Service_GamesManagement_ScoresResetMultipleForAllRequest extends GoogleGAL_Collection {
