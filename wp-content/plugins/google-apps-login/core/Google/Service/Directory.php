...
class GoogleGAL_Service_Directory extends GoogleGAL_Service {
	...
	public function __construct( GoogleGAL_Client $client ) {
		...
		$this->schemas           = new GoogleGAL_Service_Directory_Schemas_Resource(
			$this,
			$this->serviceName,
			'schemas',
			array(
 ...
 *  </code>
 */
class GoogleGAL_Service_Directory_Schemas_Resource extends GoogleGAL_Service_Resource {
	 ...
	 * @param string $schemaKey Name or immutable Id of the schema
	 * @param array  $optParams Optional parameters.
	 * @return GoogleGAL_Service_Directory_Schema
	 */
	public function get( $customerId, $schemaKey, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'get', array( $params ), 'GoogleGAL_Service_Directory_Schema' );
	}
	 ...
	 *
	 * @param string           $customerId Immutable id of the Google Apps account
	 * @param GoogleGAL_Schema $postBody
	 * @param array            $optParams Optional parameters.
	 * @return GoogleGAL_Service_Directory_Schema
	 */
	public function insert( $customerId, GoogleGAL_Service_Directory_Schema $postBody, $optParams = array() ) {
		$params = array(
			'customerId' => $customerId,
			'postBody'   => $postBody,
		);
		$params = array_merge( $params, $optParams );
		return $this->call( 'insert', array( $params ), 'GoogleGAL_Service_Directory_Schema' );
	}
	 ...
	 * @param string $customerId Immutable id of the Google Apps account
	 * @param array  $optParams Optional parameters.
	 * @return GoogleGAL_Service_Directory_Schemas
	 */
	public function listSchemas( $customerId, $optParams = array() ) {
		$params = array( 'customerId' => $customerId );
		$params = array_merge( $params, $optParams );
		return $this->call( 'list', array( $params ), 'GoogleGAL_Service_Directory_Schemas' );
	}
	 ...
	 * @return GoogleGAL_Service_Directory_Schema
	 */
	public function patch( $customerId, $schemaKey, GoogleGAL_Service_Directory_Schema $postBody, $optParams = array() ) {
		$params = array(
			'customerId' => $customerId,
			'schemaKey'  => $schemaKey,
			'postBody'   => $postBody,
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'patch', array( $params ), 'GoogleGAL_Service_Directory_Schema' );
	}
	 ...
	 * @return GoogleGAL_Service_Directory_Schema
	 */
	public function update( $customerId, $schemaKey, GoogleGAL_Service_Directory_Schema $postBody, $optParams = array() ) {
		$params = array(
			'customerId' => $customerId,
			'schemaKey'  => $schemaKey,
			'postBody'   => $postBody,
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'update', array( $params ), 'GoogleGAL_Service_Directory_Schema' );
	}
}
...
class GoogleGAL_Service_Directory_ChannelParams extends GoogleGAL_Model {

}

class GoogleGAL_Service_Directory_ChromeOsDevice extends GoogleGAL_Collection {

	protected $collection_key           = 'recentUsers';
	protected $internal_gapi_mappings   = array();
	protected $activeTimeRangesType     = 'GoogleGAL_Service_Directory_ChromeOsDeviceActiveTimeRanges';
	...
	protected $recentUsersType     = 'GoogleGAL_Service_Directory_ChromeOsDeviceRecentUsers';
...
class GoogleGAL_Service_Directory_ChromeOsDeviceActiveTimeRanges extends GoogleGAL_Model {
...
class GoogleGAL_Service_Directory_ChromeOsDeviceRecentUsers extends GoogleGAL_Model {
...
class GoogleGAL_Service_Directory_Schema extends GoogleGAL_Collection {

	protected $collection_key         = 'fields';
	protected $internal_gapi_mappings = array();
	public $etag;
	protected $fieldsType     = 'GoogleGAL_Service_Directory_SchemaFieldSpec';
...
class GoogleGAL_Service_Directory_SchemaFieldSpec extends GoogleGAL_Model {
	...
	public $kind;
	public $multiValued;
	protected $numericIndexingSpecType     = 'GoogleGAL_Service_Directory_SchemaFieldSpecNumericIndexingSpec';
	...
	public function setNumericIndexingSpec( GoogleGAL_Service_Directory_SchemaFieldSpecNumericIndexingSpec $numericIndexingSpec ) {
...
class GoogleGAL_Service_Directory_SchemaFieldSpecNumericIndexingSpec extends GoogleGAL_Model {
...
class GoogleGAL_Service_Directory_Schemas extends GoogleGAL_Collection {

	protected $collection_key         = 'schemas';
	protected $internal_gapi_mappings = array();
	public $etag;
	public $kind;
	protected $schemasType     = 'GoogleGAL_Service_Directory_Schema';
...
class GoogleGAL_Service_Directory_UserCustomProperties extends GoogleGAL_Model {

}

class GoogleGAL_Service_Directory_UserCustomSchemas extends GoogleGAL_Model {
