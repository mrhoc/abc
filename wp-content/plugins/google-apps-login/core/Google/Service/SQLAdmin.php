...
class GoogleGAL_Service_SQLAdmin_Instances_Resource extends GoogleGAL_Service_Resource {
	 ...
	 * @param array  $optParams Optional parameters.
	 * @return GoogleGAL_Service_SQLAdmin_InstancesPromoteReplicaResponse
	 */
	public function promoteReplica( $project, $instance, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'promoteReplica', array( $params ), 'GoogleGAL_Service_SQLAdmin_InstancesPromoteReplicaResponse' );
	}
...
class GoogleGAL_Service_SQLAdmin_InstancesPromoteReplicaResponse extends GoogleGAL_Model {
