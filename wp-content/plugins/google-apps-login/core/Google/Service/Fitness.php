 ...
 * @author Google, Inc.
 */
class GoogleGAL_Service_Fitness extends GoogleGAL_Service {
	...
	public function __construct( GoogleGAL_Client $client ) {
		...
		$this->users_dataSources          = new GoogleGAL_Service_Fitness_UsersDataSources_Resource(
			$this,
			$this->serviceName,
			'dataSources',
			array(
		...
		$this->users_dataSources_datasets = new GoogleGAL_Service_Fitness_UsersDataSourcesDatasets_Resource(
			$this,
			$this->serviceName,
			'datasets',
			array(
		...
		$this->users_sessions             = new GoogleGAL_Service_Fitness_UsersSessions_Resource(
			$this,
			$this->serviceName,
			'sessions',
			array(
 ...
 * Typical usage is:
 *  <code>
 *   $fitnessService = new GoogleGAL_Service_Fitness(...);
 *   $users = $fitnessService->users;
 *  </code>
 */
class GoogleGAL_Service_Fitness_Users_Resource extends GoogleGAL_Service_Resource {
 ...
 *  </code>
 */
class GoogleGAL_Service_Fitness_UsersDataSources_Resource extends GoogleGAL_Service_Resource {
	 ...
	 * @param GoogleGAL_DataSource $postBody
	 * @param array                $optParams Optional parameters.
	 * @return GoogleGAL_Service_Fitness_DataSource
	 */
	public function create( $userId, GoogleGAL_Service_Fitness_DataSource $postBody, $optParams = array() ) {
		$params = array(
			'userId'   => $userId,
			'postBody' => $postBody,
		);
		$params = array_merge( $params, $optParams );
		return $this->call( 'create', array( $params ), 'GoogleGAL_Service_Fitness_DataSource' );
	}
	...
	public function get( $userId, $dataSourceId, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'get', array( $params ), 'GoogleGAL_Service_Fitness_DataSource' );
	}
	 ...
	 * @return GoogleGAL_Service_Fitness_ListDataSourcesResponse
	 */
	public function listUsersDataSources( $userId, $optParams = array() ) {
		$params = array( 'userId' => $userId );
		$params = array_merge( $params, $optParams );
		return $this->call( 'list', array( $params ), 'GoogleGAL_Service_Fitness_ListDataSourcesResponse' );
	}
	 ...
	 * @return GoogleGAL_Service_Fitness_DataSource
	 */
	public function patch( $userId, $dataSourceId, GoogleGAL_Service_Fitness_DataSource $postBody, $optParams = array() ) {
		$params = array(
			'userId'       => $userId,
			'dataSourceId' => $dataSourceId,
			'postBody'     => $postBody,
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'patch', array( $params ), 'GoogleGAL_Service_Fitness_DataSource' );
	}
	 ...
	 * @return GoogleGAL_Service_Fitness_DataSource
	 */
	public function update( $userId, $dataSourceId, GoogleGAL_Service_Fitness_DataSource $postBody, $optParams = array() ) {
		$params = array(
			'userId'       => $userId,
			'dataSourceId' => $dataSourceId,
			'postBody'     => $postBody,
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'update', array( $params ), 'GoogleGAL_Service_Fitness_DataSource' );
	}
}
 ...
 *  </code>
 */
class GoogleGAL_Service_Fitness_UsersDataSourcesDatasets_Resource extends GoogleGAL_Service_Resource {
	 ...
	 * @return GoogleGAL_Service_Fitness_Dataset
	 */
	public function get( $userId, $dataSourceId, $datasetId, $optParams = array() ) {
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'get', array( $params ), 'GoogleGAL_Service_Fitness_Dataset' );
	}
	 ...
	 * @return GoogleGAL_Service_Fitness_Dataset
	 */
	public function patch( $userId, $dataSourceId, $datasetId, GoogleGAL_Service_Fitness_Dataset $postBody, $optParams = array() ) {
		$params = array(
			'userId'       => $userId,
			'dataSourceId' => $dataSourceId,
			'datasetId'    => $datasetId,
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'patch', array( $params ), 'GoogleGAL_Service_Fitness_Dataset' );
	}
}
/**
 ...
 *  </code>
 */
class GoogleGAL_Service_Fitness_UsersSessions_Resource extends GoogleGAL_Service_Resource {
	 ...
	 * @return GoogleGAL_Service_Fitness_ListSessionsResponse
	 */
	public function listUsersSessions( $userId, $optParams = array() ) {
		$params = array( 'userId' => $userId );
		$params = array_merge( $params, $optParams );
		return $this->call( 'list', array( $params ), 'GoogleGAL_Service_Fitness_ListSessionsResponse' );
	}
	 ...
	 * @param GoogleGAL_Session $postBody
	 * @param array             $optParams Optional parameters.
	 *
	 * @opt_param string currentTimeMillis The client's current time in milliseconds
	 * since epoch.
	 * @return GoogleGAL_Service_Fitness_Session
	 */
	public function update( $userId, $sessionId, GoogleGAL_Service_Fitness_Session $postBody, $optParams = array() ) {
		$params = array(
			'userId'    => $userId,
			'sessionId' => $sessionId,
			'postBody'  => $postBody,
		...
		$params = array_merge( $params, $optParams );
		return $this->call( 'update', array( $params ), 'GoogleGAL_Service_Fitness_Session' );
	}
}
...
class GoogleGAL_Service_Fitness_Application extends GoogleGAL_Model {
...
class GoogleGAL_Service_Fitness_DataPoint extends GoogleGAL_Collection {
	...
	protected $valueType     = 'GoogleGAL_Service_Fitness_Value';
...
class GoogleGAL_Service_Fitness_DataSource extends GoogleGAL_Model {

	protected $internal_gapi_mappings = array();
	protected $applicationType        = 'GoogleGAL_Service_Fitness_Application';
	protected $applicationDataType    = '';
	public $dataStreamId;
	public $dataStreamName;
	protected $dataTypeType     = 'GoogleGAL_Service_Fitness_DataType';
	protected $dataTypeDataType = '';
	protected $deviceType       = 'GoogleGAL_Service_Fitness_Device';
	protected $deviceDataType   = '';
	public $name;
	public $type;


	public function setApplication( GoogleGAL_Service_Fitness_Application $application ) {
	...
	public function setDataType( GoogleGAL_Service_Fitness_DataType $dataType ) {
		$this->dataType = $dataType;
	}
	public function getDataType() {
		return $this->dataType;
	}
	public function setDevice( GoogleGAL_Service_Fitness_Device $device ) {
		$this->device = $device;
	}
...
class GoogleGAL_Service_Fitness_DataType extends GoogleGAL_Collection {

	protected $collection_key         = 'field';
	protected $internal_gapi_mappings = array();
	protected $fieldType              = 'GoogleGAL_Service_Fitness_DataTypeField';
...
class GoogleGAL_Service_Fitness_DataTypeField extends GoogleGAL_Model {
...
class GoogleGAL_Service_Fitness_Dataset extends GoogleGAL_Collection {
	...
	protected $pointType     = 'GoogleGAL_Service_Fitness_DataPoint';
...
class GoogleGAL_Service_Fitness_Device extends GoogleGAL_Model {
...
class GoogleGAL_Service_Fitness_ListDataSourcesResponse extends GoogleGAL_Collection {

	protected $collection_key         = 'dataSource';
	protected $internal_gapi_mappings = array();
	protected $dataSourceType         = 'GoogleGAL_Service_Fitness_DataSource';
...
class GoogleGAL_Service_Fitness_ListSessionsResponse extends GoogleGAL_Collection {

	protected $collection_key         = 'session';
	protected $internal_gapi_mappings = array();
	protected $deletedSessionType     = 'GoogleGAL_Service_Fitness_Session';
	protected $deletedSessionDataType = 'array';
	public $nextPageToken;
	protected $sessionType     = 'GoogleGAL_Service_Fitness_Session';
...
class GoogleGAL_Service_Fitness_Session extends GoogleGAL_Model {
...
class GoogleGAL_Service_Fitness_Value extends GoogleGAL_Model {
