                ...
                <div class="row list-member__row align-items-center">
                    <div class="md:col-8 col-12">
                        <div class="list-member__content">
                            ...
                            <p class="section-member__title" data-aos="fade-up">
                                片岡 義隆
                                <i class="ff-cormorant fw-semibold">Yoshitaka Kataoka</i>
                            </p>
                            <p class="section-member__text mb-0 md:d-block d-none" data-aos="fade-up">
                    ...
                    <div class="md:col-4 col-12">
                        <img class="w-full" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/company/img-member-3.jpg" alt="Laetoli Board Member" data-aos="fade-up">
                    </div>
                    <div class="col-12 md:d-none">
                        <div class="list-member__content mt-4">
                            <p class="section-member__text mb-0" data-aos="fade-up">
                                大学卒業後、大手不動産鑑定事務所にて不動産鑑定業務に従事。その後1兆円規模の米系不動産投資ファンド、5 兆円規模の米系ヘッジファンドにおいて投資業務に従事。その後スタートアップ複数社の起業、経営を経験。投資領域及びスタートアップ領域における豊富な経験を有する。
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="md:col-8 col-12">
                        <div class="list-member__content">
                            ...
                            <p class="section-member__text mb-0 mb-0 md:d-block d-none" data-aos="fade-up">
                                大学院修了後、外資系コンサルティング会社（現アクセンチュア）にて会計システムの設計開発を経験したのち、大手外資系会計事務所（現KPMG税理士法人）にて不動産ファンドの税務申告、税務コンサルティング、税務デューデリジェンス等に従事。大手外資系不動産ファンドにて住居からホテル、ゴルフ場等幅広い投資案件の財務経理業務に従事し、監査法人折衝を数多く経験するとともに、投資先事業会社の社外取締役を兼務。2017年8月に独立。投資案件の管理運営に関するコンサルティング、サポートサービスを提供。
                            </p>
                        </div>
                    </div>
                    <div class="md:col-4 col-12">
    ...
    <section class="section-profile section-square bg-gray-lighter fw-medium">
        ...
        <div class="container-fluid container-fluid--custom">
            <div class="history-wrapper page-company__wrapper">
                ...
                <p class="history-wrapper__note fs-1 mb-0" data-aos="fade-up">(注釈)　　<br class="md:d-none">※電子取引…インターネット上での契約締結を行う取引　　<br class="md:d-none">※クラウドファンディング…不特定多数の人々からインターネットを通して資金を集めること</p>
            </div>
        </div>
    </section>
    <!-- Company Profile -->
